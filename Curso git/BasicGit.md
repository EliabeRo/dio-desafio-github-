...
["Hostinger Tutoriais"]([Comandos Básicos de GIT (hostinger.com.br)](https://www.hostinger.com.br/tutoriais/comandos-basicos-de-git#:~:text=Um dos comandos git mais usados é o,definir o email%3A git config --global user.email sam%40google.com))
